...
Smithery Deployments allow you to host your [standard input/output (STDIO)](https://modelcontextprotocol.io/docs/concepts/transports#standard-input-output-stdio) MCP server on Smithery served over [streamable HTTP](https://modelcontextprotocol.io/specification/2025-03-26/basic/transports#streamable-http) connection.
