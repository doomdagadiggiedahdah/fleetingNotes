...
### Authentication
All endpoints require authentication via a bearer token. You can create an API key <a href="/account/api-keys" target="_blank" className="text-[#cb4b16] hover:text-[#cb4b16]/80">here</a>.
