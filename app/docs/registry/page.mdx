...
- `securityScan`: Information about the server's security status (recently added feature)
  - `isSecure`: A boolean indicating whether the server has passed security checks. This field will be `null` if no security scan has been performed yet.
