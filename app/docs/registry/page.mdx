...
### Authentication
All endpoints require authentication via a bearer token. Currently, API keys are approved manually. You can tell us what you're trying to build and request an API key by [contacting us](mailto:contact@smithery.ai).
