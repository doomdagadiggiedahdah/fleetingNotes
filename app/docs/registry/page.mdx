...
<CodeBlock 
  language="http" 
  code="https://server.smithery.ai/${qualifiedName}/ws?config=${base64encode(config)}"
  showHeader={true}
  className="my-4"
/>
...
<CodeBlock 
  language="typescript" 
  code={`import { WebSocketClientTransport } from "@modelcontextprotocol/sdk/client/websocket.js"
