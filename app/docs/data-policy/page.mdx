...
export const metadata = {
  title: 'Data Policy | Smithery Documentation',
...
1. When you perform calls to hosted MCPs, Smithery tracks the calls made to the tool for analytics purposes. This is used to display a usage counter on our homepage to help improve the overall user experience.
...
1. Install tracking: This tracks the number of times a local MCP is installed.
