...
Smithery allows AI agents to connect to a large catalog of Model Context Protocol (MCP) servers. This guide explains how to integrate Smithery into your application (MCP Client), with two primary approaches to authentication and configuration management.

## Integration Approaches

There are two main ways to integrate Smithery with your client application:
